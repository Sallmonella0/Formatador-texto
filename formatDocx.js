const { Document, Packer, Paragraph, TextRun, Header, Footer, AlignmentType } = require("docx");
...
exports.formatDocx = async function formatDocx(
  ...
  const style = STYLES[styleKey] || STYLES.abnt;
  ...
  // CABEÇALHO e RODAPÉ (Simplificado - DOCX lida com numeração)
